      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <a 
              href="mailto:vamsichintalapudi873@gmail.com"
            ...
            >
              ...
              <div>
                ...
                <p className="font-medium">vamsichintalapudi873@gmail.com</p>
              </div>
            </a>
          ...
          <div className="flex justify-center gap-4">
            <Button 
              ...
              asChild
            >
              <a href="mailto:vamsichintalapudi873@gmail.com">Send Email</a>
            </Button>
            <Button 
              size="lg" 
              variant="outline"
